...
START = emojize(':handshake_light_skin_tone_dark_skin_tone: '
                'Выберите языковую пару, а затем пришлите мне слово '
                'или простое словосочетание, чтобы получить '
...
HELP = emojize('"Translate This!" – бот для перевода слов '
               ...
               '/picklanguages, а затем напишите мне слово или'
               'простое словосочетание, чтобы получить перевод '
